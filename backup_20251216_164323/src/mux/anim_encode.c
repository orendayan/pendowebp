...
static PENDO_WEBP_INLINE int ComparePixelsLossless(const uint32_t* src, int src_step,
...
// 'max_allowed_diff'.
static PENDO_WEBP_INLINE int PixelsAreSimilar(uint32_t src, uint32_t dst,
...
static PENDO_WEBP_INLINE int ComparePixelsLossy(const uint32_t* src, int src_step,
                                          const uint32_t* dst, int dst_step,
                                          int length, int max_allowed_diff) {
  assert(length > 0);
  while (length-- > 0) {
...
static PENDO_WEBP_INLINE void SnapToEvenOffsets(FrameRectangle* const rect) {
...
static PENDO_WEBP_INLINE int clip(int v, int min_v, int max_v) {
