...
#ifndef PENDO_WEBP_WEBP_MUX_H_
#define PENDO_WEBP_WEBP_MUX_H_
...
PENDO_WEBP_EXTERN int WebPGetMuxVersion(void);

//------------------------------------------------------------------------------
// Life of a Mux object

// Internal, version-checked, entry point
PENDO_WEBP_EXTERN WebPMux* WebPNewInternal(int);

// Creates an empty mux object.
// Returns:
//   A pointer to the newly created empty mux object.
//   Or NULL in case of memory error.
static PENDO_WEBP_INLINE WebPMux* WebPMuxNew(void) {
...
PENDO_WEBP_EXTERN void WebPMuxDelete(WebPMux* mux);

//------------------------------------------------------------------------------
// Mux creation.

// Internal, version-checked, entry point
PENDO_WEBP_EXTERN WebPMux* WebPMuxCreateInternal(const WebPData*, int, int);
...
static PENDO_WEBP_INLINE WebPMux* WebPMuxCreate(const WebPData* bitstream,
                                          int copy_data) {
...
PENDO_WEBP_EXTERN WebPMuxError WebPMuxSetChunk(
...
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxGetChunk(
...
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxDeleteChunk(
...
//   WEBP_MUX_MEMORY_ERROR - on memory allocation error.
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxSetImage(
...
//   WEBP_MUX_MEMORY_ERROR - on memory allocation error.
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxPushFrame(
...
//   WEBP_MUX_MEMORY_ERROR - on memory allocation error.
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxGetFrame(
...
//                        before deletion.
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxDeleteFrame(WebPMux* mux, uint32_t nth);
...
//   WEBP_MUX_MEMORY_ERROR - on memory allocation error.
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxSetAnimationParams(
...
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxGetAnimationParams(
...
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxSetCanvasSize(WebPMux* mux,
...
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxGetCanvasSize(const WebPMux* mux,
                                              int* width, int* height);
...
//   WEBP_MUX_BAD_DATA - if VP8X/VP8/VP8L chunk or canvas size is invalid.
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxGetFeatures(const WebPMux* mux,
                                            uint32_t* flags);
...
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxNumChunks(const WebPMux* mux,
...
//   WEBP_MUX_MEMORY_ERROR - on memory allocation error.
//   WEBP_MUX_OK - on success.
PENDO_WEBP_EXTERN WebPMuxError WebPMuxAssemble(WebPMux* mux,
...
// Internal, version-checked, entry point.
PENDO_WEBP_EXTERN int WebPAnimEncoderOptionsInitInternal(
...
// 'enc_options' object.
static PENDO_WEBP_INLINE int WebPAnimEncoderOptionsInit(
    WebPAnimEncoderOptions* enc_options) {
  return WebPAnimEncoderOptionsInitInternal(enc_options, WEBP_MUX_ABI_VERSION);
}

// Internal, version-checked, entry point.
PENDO_WEBP_EXTERN WebPAnimEncoder* WebPAnimEncoderNewInternal(
...
//   Or NULL in case of memory error.
static PENDO_WEBP_INLINE WebPAnimEncoder* WebPAnimEncoderNew(
...
PENDO_WEBP_EXTERN int WebPAnimEncoderAdd(
...
// Returns:
//   True on success.
PENDO_WEBP_EXTERN int WebPAnimEncoderAssemble(WebPAnimEncoder* enc,
                                        WebPData* webp_data);
...
PENDO_WEBP_EXTERN const char* WebPAnimEncoderGetError(WebPAnimEncoder* enc);

// Deletes the WebPAnimEncoder object.
// Parameters:
//   enc - (in/out) object to be deleted
PENDO_WEBP_EXTERN void WebPAnimEncoderDelete(WebPAnimEncoder* enc);
