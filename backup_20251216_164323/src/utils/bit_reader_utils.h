...
//   static PENDO_WEBP_INLINE int VP8GetBit(VP8BitReader* const br, int prob, ...)
//   static PENDO_WEBP_INLINE int VP8GetSigned(VP8BitReader* const br, int v, ...)
...
static PENDO_WEBP_INLINE uint32_t VP8LPrefetchBits(VP8LBitReader* const br) {
  return (uint32_t)(br->val_ >> (br->bit_pos_ & (VP8L_LBITS - 1)));
}

// Returns true if there was an attempt at reading bit past the end of
// the buffer. Doesn't set br->eos_ flag.
static PENDO_WEBP_INLINE int VP8LIsEndOfStream(const VP8LBitReader* const br) {
...
static PENDO_WEBP_INLINE void VP8LSetBitPos(VP8LBitReader* const br, int val) {
  br->bit_pos_ = val;
}
...
static PENDO_WEBP_INLINE void VP8LFillBitWindow(VP8LBitReader* const br) {
