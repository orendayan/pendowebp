...
static WEBP_UBSAN_IGNORE_UNDEF PENDO_WEBP_INLINE
...
static PENDO_WEBP_INLINE int VP8GetBit(VP8BitReader* WEBP_RESTRICT const br,
...
static PENDO_WEBP_INLINE int VP8GetBitAlt(VP8BitReader* WEBP_RESTRICT const br,
                                    int prob, const char label[]) {
  // Don't move this declaration! It makes a big speed difference to store
  // 'range' *before* calling VP8LoadNewBytes(), even if this function doesn't
  // alter br->range_ value.
