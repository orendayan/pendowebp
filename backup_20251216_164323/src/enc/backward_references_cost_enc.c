...
static PENDO_WEBP_INLINE float GetLiteralCost(const CostModel* const m, uint32_t v) {
...
static PENDO_WEBP_INLINE float GetCacheCost(const CostModel* const m, uint32_t idx) {
  const int literal_idx = VALUES_IN_BYTE + NUM_LENGTH_CODES + idx;
  return m->literal_[literal_idx];
}

static PENDO_WEBP_INLINE float GetLengthCost(const CostModel* const m,
                                       uint32_t length) {
  int code, extra_bits;
...
static PENDO_WEBP_INLINE float GetDistanceCost(const CostModel* const m,
                                         uint32_t distance) {
  int code, extra_bits;
...
static PENDO_WEBP_INLINE void AddSingleLiteralWithCostModel(
...
static PENDO_WEBP_INLINE void UpdateCost(CostManager* const manager, int i,
...
static PENDO_WEBP_INLINE void UpdateCostPerInterval(CostManager* const manager,
...
static PENDO_WEBP_INLINE void ConnectIntervals(CostManager* const manager,
...
static PENDO_WEBP_INLINE void PopInterval(CostManager* const manager,
                                    CostInterval* const interval) {
...
static PENDO_WEBP_INLINE void UpdateCostAtIndex(CostManager* const manager, int i,
...
static PENDO_WEBP_INLINE void PositionOrphanInterval(CostManager* const manager,
...
static PENDO_WEBP_INLINE void InsertInterval(CostManager* const manager,
...
static PENDO_WEBP_INLINE void PushInterval(CostManager* const manager,
