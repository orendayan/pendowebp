...
static PENDO_WEBP_INLINE int VP8RecordStats(int bit, proba_t* const stats) {
  proba_t p = *stats;
...
static PENDO_WEBP_INLINE int VP8BitCost(int bit, uint8_t proba) {
...
static PENDO_WEBP_INLINE int VP8LevelCost(const uint16_t* const table, int level) {
