...
static PENDO_WEBP_INLINE float BitsEntropyRefine(const VP8LBitEntropy* entropy) {
  float mix;
...
static PENDO_WEBP_INLINE float GetCombinedEntropy(const uint32_t* const X,
...
static PENDO_WEBP_INLINE void HistogramAdd(const VP8LHistogram* const a,
                                     const VP8LHistogram* const b,
