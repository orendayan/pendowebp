...
static PENDO_WEBP_INLINE int FindMatchLength(const uint32_t* const array1,
...
static PENDO_WEBP_INLINE int MaxFindCopyLength(int len) {
...
static PENDO_WEBP_INLINE void AddSingleLiteral(uint32_t pixel, int use_color_cache,
