...
static PENDO_WEBP_INLINE uint32_t GammaToLinear(uint8_t v) {
  return kGammaToLinearTab[v];
}

static PENDO_WEBP_INLINE int Interpolate(int v) {
...
static PENDO_WEBP_INLINE int LinearToGamma(uint32_t base_value, int shift) {
...
static void InitGammaTables(void) {}
static PENDO_WEBP_INLINE uint32_t GammaToLinear(uint8_t v) { return v; }
static PENDO_WEBP_INLINE int LinearToGamma(uint32_t base_value, int shift) {
...
static PENDO_WEBP_INLINE int LinearToGammaWeighted(const uint8_t* src,
                                             const uint8_t* a_ptr,
...
static PENDO_WEBP_INLINE void ConvertRowToY(const uint8_t* const r_ptr,
...
static PENDO_WEBP_INLINE void AccumulateRGBA(const uint8_t* const r_ptr,
                                       const uint8_t* const g_ptr,
                                       const uint8_t* const b_ptr,
...
static PENDO_WEBP_INLINE void AccumulateRGB(const uint8_t* const r_ptr,
                                      const uint8_t* const g_ptr,
                                      const uint8_t* const b_ptr,
                                      int step, int rgb_stride,
                                      uint16_t* dst, int width) {
...
static PENDO_WEBP_INLINE void ConvertRowsToUV(const uint16_t* rgb,
                                        uint8_t* const dst_u,
                                        uint8_t* const dst_v,
                                        int width,
                                        VP8Random* const rg) {
