...
static PENDO_WEBP_INLINE __m128i Load_HI_16_SSE41(const uint8_t* src) {
  const __m128i zero = _mm_setzero_si128();
  return _mm_unpacklo_epi8(zero, _mm_loadl_epi64((const __m128i*)src));
}

// Load and replicate the U/V samples
static PENDO_WEBP_INLINE __m128i Load_UV_HI_8_SSE41(const uint8_t* src) {
  const __m128i zero = _mm_setzero_si128();
...
static PENDO_WEBP_INLINE void PlanarTo24b_SSE41(
...
static PENDO_WEBP_INLINE void RGB24PackedToPlanar_SSE41(
...
static PENDO_WEBP_INLINE void RGB32PackedToPlanar_SSE41(
...
static PENDO_WEBP_INLINE void ConvertRGBToY_SSE41(const __m128i* const R,
...
static PENDO_WEBP_INLINE void ConvertRGBToUV_SSE41(const __m128i* const R,
                                             const __m128i* const G,
                                             const __m128i* const B,
                                             __m128i* const U,
                                             __m128i* const V) {
...
static PENDO_WEBP_INLINE void RGBA32PackedToPlanar_16b_SSE41(
