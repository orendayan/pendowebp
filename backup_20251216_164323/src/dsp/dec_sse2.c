...
static PENDO_WEBP_INLINE void SignedShift8b_SSE2(__m128i* const x) {
  const __m128i zero = _mm_setzero_si128();
...
static PENDO_WEBP_INLINE void GetNotHEV_SSE2(const __m128i* const p1,
...
static PENDO_WEBP_INLINE void GetBaseDelta_SSE2(const __m128i* const p1,
                                          const __m128i* const p0,
                                          const __m128i* const q0,
                                          const __m128i* const q1,
                                          __m128i* const delta) {
...
static PENDO_WEBP_INLINE void DoSimpleFilter_SSE2(__m128i* const p0,
                                            __m128i* const q0,
...
static PENDO_WEBP_INLINE void Update2Pixels_SSE2(__m128i* const pi, __m128i* const qi,
...
static PENDO_WEBP_INLINE void NeedsFilter_SSE2(const __m128i* const p1,
                                         const __m128i* const p0,
                                         const __m128i* const q0,
                                         const __m128i* const q1,
...
static PENDO_WEBP_INLINE void DoFilter2_SSE2(__m128i* const p1, __m128i* const p0,
...
static PENDO_WEBP_INLINE void DoFilter4_SSE2(__m128i* const p1, __m128i* const p0,
                                       __m128i* const q0, __m128i* const q1,
...
static PENDO_WEBP_INLINE void DoFilter6_SSE2(__m128i* const p2, __m128i* const p1,
...
static PENDO_WEBP_INLINE void Load8x4_SSE2(const uint8_t* const b, int stride,
...
static PENDO_WEBP_INLINE void Load16x4_SSE2(const uint8_t* const r0,
...
static PENDO_WEBP_INLINE void Store4x4_SSE2(__m128i* const x,
...
static PENDO_WEBP_INLINE void Store16x4_SSE2(const __m128i* const p1,
                                       const __m128i* const p0,
                                       const __m128i* const q0,
                                       const __m128i* const q1,
...
static PENDO_WEBP_INLINE void ComplexMask_SSE2(const __m128i* const p1,
                                         const __m128i* const p0,
                                         const __m128i* const q0,
                                         const __m128i* const q1,
...
static PENDO_WEBP_INLINE void TrueMotion_SSE2(uint8_t* dst, int size) {
