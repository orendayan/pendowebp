...
#if 0
#include <stdio.h>
static PENDO_WEBP_INLINE void PrintReg(const __m128i r, const char* const name,
                                 int size) {
  int n;
  union {
    __m128i r;
...
static PENDO_WEBP_INLINE int VP8HorizontalAdd8b(const __m128i* const a) {
...
static PENDO_WEBP_INLINE void VP8Transpose_2_4x4_16b(
...
static PENDO_WEBP_INLINE void VP8PlanarTo24b_SSE2(
...
static PENDO_WEBP_INLINE void VP8L32bToPlanar_SSE2(__m128i* const in0,
                                             __m128i* const in1,
                                             __m128i* const in2,
                                             __m128i* const in3) {
