...
static PENDO_WEBP_INLINE void DoHorizontalFilter_SSE2(const uint8_t* in,
...
static PENDO_WEBP_INLINE void DoVerticalFilter_SSE2(const uint8_t* in,
...
static PENDO_WEBP_INLINE int GradientPredictor_SSE2(uint8_t a, uint8_t b, uint8_t c) {
  const int g = a + b - c;
...
static PENDO_WEBP_INLINE void DoGradientFilter_SSE2(const uint8_t* in,
                                              int width, int height, int stride,
                                              int row, int num_rows,
                                              uint8_t* out) {
  const size_t start_offset = row * stride;
