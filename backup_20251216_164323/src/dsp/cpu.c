...
static PENDO_WEBP_INLINE void GetCPUInfo(int cpu_info[4], int info_type) {
  __asm__ volatile (
    "mov %%ebx, %%edi\n"
    "cpuid\n"
    "xchg %%edi, %%ebx\n"
...
static PENDO_WEBP_INLINE uint64_t xgetbv(void) {
...
PENDO_WEBP_EXTERN VP8CPUInfo VP8GetCPUInfo;
