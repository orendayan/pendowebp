...
static PENDO_WEBP_INLINE void ExportRowExpand_0(const uint32_t* frow, uint8_t* dst,
                                          int length,
...
static PENDO_WEBP_INLINE void ExportRowExpand_1(const uint32_t* frow, uint32_t* irow,
...
static PENDO_WEBP_INLINE void ExportRowShrink_0(const uint32_t* frow, uint32_t* irow,
                                          uint8_t* dst, int length,
...
static PENDO_WEBP_INLINE void ExportRowShrink_1(uint32_t* irow, uint8_t* dst,
                                          int length,
                                          WebPRescaler* const wrk) {
