...
static PENDO_WEBP_INLINE void DoHorizontalFilter_NEON(const uint8_t* in,
...
static PENDO_WEBP_INLINE void DoVerticalFilter_NEON(const uint8_t* in,
...
static PENDO_WEBP_INLINE void DoGradientFilter_NEON(const uint8_t* in,
                                              int width, int height,
                                              int stride,
                                              int row, int num_rows,
                                              uint8_t* out) {
