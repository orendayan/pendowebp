...
static PENDO_WEBP_INLINE void PredictLine_MIPSdspR2(const uint8_t* src, uint8_t* dst,
                                              int length) {
...
static PENDO_WEBP_INLINE void DoHorizontalFilter_MIPSdspR2(const uint8_t* in,
...
static PENDO_WEBP_INLINE void DoVerticalFilter_MIPSdspR2(const uint8_t* in,
                                                   int width, int height,
                                                   int stride,
                                                   int row, int num_rows,
                                                   uint8_t* out) {
